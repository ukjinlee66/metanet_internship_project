...
const Ticker=()=>
{
    ...
    const out = () =>
    {
        ...
        return <button style={{backgroundColor: "transparent",borderColor: "transparent"}}onClick = {btClick} value={rankingList[1].searchWordName}>{rankingList[1].searchWordName}</button>;
    }

    


    return (    <div>#2 {out()}</div>
