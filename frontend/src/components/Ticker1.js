...
const Ticker=()=>
{
    ...
    const out = () =>
    {
        ...
        return <button style={{backgroundColor: "transparent",borderColor: "transparent"}}onClick = {btClick} value={rankingList[0].searchWordName}>{rankingList[0].searchWordName}</button>;
    }
