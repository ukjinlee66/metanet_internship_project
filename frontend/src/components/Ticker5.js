...
const Ticker=()=>
{
    ...
    const out = () =>
    {
        ...
        return <button style={{backgroundColor: "transparent",borderColor: "transparent"}}onClick = {btClick} value={rankingList[4].searchWordName}>{rankingList[4].searchWordName}</button>;
    }

    


    return (    <div>#5{out()}</div>
